  ...
  return (
    <div style={S.page}>
      <div style={S.card}>
        ...
        {reason === 'suspended' && (
          <div style={S.error}>Compte suspendu. Contacter l'administrateur.</div>
        )}
        ...
        <div style={S.footer}>
          Document confidentiel — Accès réservé aux investisseurs<br />
          Contact : contact@senegal-invest.com
        </div>
      </div>
    </div>
  )
